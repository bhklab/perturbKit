...
downloadL1kData <- function(mypath, version=2017){
  ...
  if (version == 2017){
    ...
    if (!myfiles_exist){
      ...
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5FLevel5%5FCOMPZ%2EMODZ%5Fn473647x12328%2Egctx%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_Level5_COMPZ.MODZ_n473647x12328.gctx.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5FREADME%2Epdf", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_README.pdf"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5Fcell%5Finfo%2Etxt%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_cell_info.txt.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5Fgene%5Finfo%2Etxt%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_gene_info.txt.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5Fpert%5Finfo%2Etxt%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_pert_info.txt.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5Fpert%5Fmetrics%2Etxt%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_pert_metrics.txt.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5Fsig%5Finfo%2Etxt%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_sig_info.txt.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5Fsig%5Fmetrics%2Etxt%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_sig_metrics.txt.gz"))
      utils::download.file(url="https://ftp.ncbi.nlm.nih.gov/geo/series/GSE92nnn/GSE92742/suppl/GSE92742%5FBroad%5FLINCS%5FLevel3%5FINF%5Fmlr12k%5Fn1319138x12328%2Egctx%2Egz", 
                    destfile=file.path(mypath, "GSE92742_Broad_LINCS_Level3_INF_mlr12k_n1319138x12328.gctx.gz"))
      utils::download.file(url="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5990023/bin/NIHMS917441-supplement-11.xlsx", 
    ...
    if (!myfiles_exist){
      ...
      utils::download.file(url="https://s3.amazonaws.com/macchiato.clue.io/builds/LINCS2020/cellinfo_beta.txt", 
      ...
      utils::download.file(url="https://s3.amazonaws.com/macchiato.clue.io/builds/LINCS2020/siginfo_beta.txt", 
                    destfile=file.path(mypath, "siginfo_beta.txt"))
      utils::download.file(url="https://s3.amazonaws.com/macchiato.clue.io/builds/LINCS2020/instinfo_beta.txt", 
...
read_l1k_meta <- function(mypath, version=2017){
  if (version == 2017){
    cellinfo <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_cell_info.txt", sep="/"), stringsAsFactors=FALSE)
    geneinfo <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_gene_info.txt", sep="/"), stringsAsFactors=FALSE)
    pertinfo <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_pert_info.txt", sep="/"), stringsAsFactors=FALSE)
    siginfo <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_sig_info.txt", sep="/"), stringsAsFactors=FALSE)
    instinfo <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_inst_info.txt", sep="/"), stringsAsFactors=FALSE)
    
    geneinfo$pr_gene_id <- as.character(geneinfo$pr_gene_id)
    
    pertmetrics <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_pert_metrics.txt", sep="/"), stringsAsFactors=FALSE)
    sigmetrics <- utils::read.delim(file=paste(mypath, "GSE92742_Broad_LINCS_sig_metrics.txt", sep="/"), stringsAsFactors=FALSE)
    ...
    cellinfo <- utils::read.delim(file=file.path(mypath, "cellinfo_beta.txt"), stringsAsFactors = FALSE)
    geneinfo <- utils::read.delim(file=file.path(mypath, "geneinfo_beta.txt"), stringsAsFactors = FALSE)
    pertinfo <- utils::read.delim(file=file.path(mypath, "compoundinfo_beta.txt"), stringsAsFactors = FALSE)
    siginfo <- utils::read.delim(file=file.path(mypath, "siginfo_beta.txt"), stringsAsFactors = FALSE)
